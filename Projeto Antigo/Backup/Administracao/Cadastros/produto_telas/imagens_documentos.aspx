<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="imagens_documentos.aspx.cs" Inherits="Projeto.Cadastros.produto_telas.WebForm6" %>
...
<body>
   ...
   <legend class="field">Imagens e Documentos
                 ...
                 cellspacing="5" class="style1">
                     <tr>
                       <td width="166" height="21">Referência:</td>
                       <td width="575" colspan="2">Descrição:</td>
                     </tr>
                     <tr>
                 ...
                 style="height: 264px">
                     <tr>
                       <td width="28%" height="27">Imagem:</td>
                       <td width="72%">Documento:</td>
                     </tr>
                     <tr>
                       <td rowspan="2">
                           <img alt="" src="../../images2/14.jpg" style="height: 218px; width: 201px" 
                               border="1" /></td>
                       <td height="36">
